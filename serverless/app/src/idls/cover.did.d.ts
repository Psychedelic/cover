...
export interface _SERVICE {
  add_provider: (arg_0: AddProvider) => Promise<{ Ok: null } | { Err: Error }>;
  add_verification: (
    arg_0: AddVerification
  ) => Promise<{ Ok: null } | { Err: Error }>;
  delete_provider: (arg_0: Principal) => Promise<{ Ok: null } | { Err: Error }>;
  ...
  get_verification_by_canister_id: (
    arg_0: Principal
  ) => Promise<[] | [Verification]>;
  update_provider: (
    arg_0: UpdateProvider
  ) => Promise<{ Ok: null } | { Err: Error }>;
  update_verification: (
    arg_0: UpdateVerification
  ) => Promise<{ Ok: null } | { Err: Error }>;
}
